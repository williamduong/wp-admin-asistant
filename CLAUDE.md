# WP Admin AI Assistant — Claude Code Guide

## Project summary

WordPress plugin: AI chat agent embedded in `wp-admin`. Supports Anthropic Claude, Google Gemini, and Ollama. Admins manage plugins, themes, posts, users, settings through natural language.
